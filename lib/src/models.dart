...
final Map MODEL_NAME_TO_CLASS_MAPPING = {};
final Map MODEL_CLASS_TO_NAME_MAPPING = {};
...
// /// @private
// Future sessionRun(session, inputs) async {
...
// /// @private
// Future decoderForward(PreTrainedModel self, Map model_inputs, [bool is_encoder_decoder = false]) async {
//   final session = self.sessions[is_encoder_decoder ? 'decoder_model_merged' : 'model'];
//
//   final past_key_values = model_inputs['past_key_values'];
//   final Map<String, dynamic> new_model_inputs = { ...model_inputs }..remove('past_key_values');
//
//   if (session.inputNames.containsKey('use_cache_branch')) {
//     new_model_inputs['use_cache_branch'] = boolTensor(!!past_key_values);
//   }
//   if (session.inputNames.containsKey('position_ids') && new_model_inputs['attention_mask'] != null && !new_model_inputs['position_ids']) {
//     // NOTE: Handle a special case for paligemma/gemma3 models, where positions are 1-indexed
//     final start_index = ['paligemma', 'gemma3_text', 'gemma3'].contains(self.config['model_type']) ? 1 : 0;
...
// /// ```
// List<int> createPositionIds(model_inputs, [bool past_key_values = false, int start_index = 0]) {
//   throw UnimplementedError('Not yet implemented');
// //   // const { input_ids, inputs_embeds, attention_mask } = model_inputs;
// //   final input_ids = model_inputs['input_ids'];
// //   final inputs_embeds = model_inputs['inputs_embeds'];
// //   final attention_mask = model_inputs['attention_mask'];
// //
// //   final { data, dims } = cumsum_masked_fill(attention_mask, start_index);
// //   let position_ids = new Tensor('int64', data, dims);
// //   if (past_key_values) {
// //     final offset = -(input_ids ?? inputs_embeds).dims.at(1);
...
//   ) => PreTrainedModel(config, sessions, configs);
//
...
//
//   dynamic _forward = null;
//
//   dynamic _prepare_inputs_for_generation = null;
//
...
//   PreTrainedModel(this.config, this.sessions, this.configs) {
//     final modelName = MODEL_CLASS_TO_NAME_MAPPING[constructor];
...
//     custom_config = config['transformers.js_config'] ?? {};
//   }
...
//   static List<Map<String, Object>>? MODEL_CLASS_MAPPINGS;
//
...
//   static from_pretrained(String pretrained_model_name_or_path, [PretrainedOptions? options]) async {
//
//     // {
//     //   progress_callback = null,
//     // config = null,
...
//
//     if (MODEL_CLASS_MAPPINGS == null) {
//       throw UnimplementedError("`MODEL_CLASS_MAPPINGS` not implemented for this type of `AutoClass`: $name");
//     }
//
//     final model_type = options.config.model_type;
//     for (final MODEL_CLASS_MAPPING in MODEL_CLASS_MAPPINGS!) {
//       Object? modelInfo = MODEL_CLASS_MAPPING[model_type];
//
//       if (modelInfo == null) {
...
// }
//
// const Map<String, Map<String, (String, Object)>> CUSTOM_ARCHITECTURES = {
...
//
//     mapping[name] = ('PreTrainedModel', PreTrainedModel);
